...
function AdminPaymentsPage() {
  ...
  const doRefund = useServerFn(adminRefundPayment);
  const doFetchEscrow = useServerFn(adminGetEscrowDetails);
  const doFetchRevenue = useServerFn(adminGetRevenueDetails);
